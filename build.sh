...
./gradlew :main:assembleDebug :main:assembleRelease
mkdir ../outputdebugmain
mkdir ../outputreleasemain
cp main/build/outputs/apk/debug/*.apk ../outputdebugmain
cp main/build/outputs/apk/release/*.apk ../outputreleasemain
